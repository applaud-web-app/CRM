...
jQuery(document).ready(function() {
    $('[data-bs-toggle="popover"]').popover(), super_dash.init()
}), jQuery(window).on("load", function() {
    "use strict";
    super_dash.load(), setTimeout(function() {
        super_dash.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function() {
    "use strict";
    super_dash.resize(), setTimeout(function() {
        super_dash.handleMenuPosition()
    }, 1e3)
});