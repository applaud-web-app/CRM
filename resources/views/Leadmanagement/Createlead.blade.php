                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="code" placeholder="Enter Lead Code">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-3">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id=""
                                        placeholder="Enter Drescription" style="height:100px;"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-3">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="close_date" placeholder="Enter date">
                                </div>
                            </div>
