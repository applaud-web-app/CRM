...
{{-- 
<table class="data-table table display text-black" id="example5">
    <thead>
        <tr>
            <th>
                #
...
{{-- @php $i=1; @endphp
        ...
        <tr>
            <td>{{$i}}</td>
            <td>{{$enquiry->name}}</td>
            <td>{{$enquiry->interested}}</td>
            <td>{{$enquiry->email}}</td>
            <td>{{$enquiry->mobile}}</td>
            <td class="wspace-no">{{$enquiry->created_at}}</span></td>
            <td class="wspace-no">{{$enquiry->source}} </td>
                    ...
                    <div class="dropdown-menu dropdown-menu-end border py-0"
                        ...
                        <div class="py-2">
                            ...
                            <a class="dropdown-item text-secondary"
                                href="convert-to-lead.php"><i
                                    class="far fa-check-square"></i> Convert To Lead</a>
                        </div>
                    </div>
            </td>
        </tr>
