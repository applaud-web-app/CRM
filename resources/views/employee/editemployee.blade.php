...
<section class="content-body">
    ...
    <div class="container-fluid">
        ...
        <form class="row" method="POST" action="{{route("posteditemployee",$data->id)}}">@csrf
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="first_name"  value="{{$data->first_name}}" placeholder="Enter Name">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="last_name" value="{{$data->last_name}}"  placeholder="Enter Name">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="emp_code" value="{{$data->emp_code}}" placeholder="Enter Employee Code">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-3">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="department" class="form-control" >
                                        ...
                                        <option value="UI/UX" @if($data->department) selected @endif>UI/UX</option>
                                        <option value="Support" @if($data->department) selected @endif>Support</option>
                                        <option value="HR" @if($data->department) selected @endif>HR</option>
                                        <option value="Engineering" @if($data->department) selected @endif>Engineering</option>
                                    </select>
                                </div>
                            </div>
